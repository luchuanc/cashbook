export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { name: "description", content: "陆家账本，快速记账!" },
        { name: "theme-color", content: "#16a34a" },
        { name: "apple-mobile-web-app-capable", content: "yes" },
        { name: "apple-mobile-web-app-status-bar-style", content: "default" },
        { name: "apple-mobile-web-app-title", content: "陆家账本" },
        { name: "application-name", content: "陆家账本" },
        { name: "msapplication-TileColor", content: "#16a34a" },
        { name: "msapplication-tap-highlight", content: "no" },
        { name: "mobile-web-app-capable", content: "yes" },
        { property: "og:title", content: "陆家账本" },
        { property: "og:description", content: "陆家账本，快速记账!" },
